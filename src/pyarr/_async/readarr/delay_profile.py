...
class DelayProfile(CommonActions):
    ...
    async def get(self, item_id: int | None = None) -> JsonArray | JsonObject:
        ...
        """
        return await self._get("delayprofile", item_id=item_id)
    ...
    async def add(
        ...
        response = await self.handler.request("delayprofile", method="POST", json_data=json_data)
    ...
    async def delete(self, item_id: int) -> None:
        ...
        """
        await self._delete("delayprofile", item_id=item_id)
