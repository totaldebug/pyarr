...
class Album(CommonActions):
    ...
    async def get(
        ...
        return await self._get("album", item_id=item_id, params=params)
    ...
    async def add(
        ...
        response = await self.handler.request("album", method="POST", json_data=album)
    ...
    async def update(self, data: JsonObject) -> JsonObject:
        ...
        """
        response = await self.handler.request("album", method="PUT", json_data=data)
        if isinstance(response, dict):
            return response
        raise ValueError("Expected a dictionary response from the 'album' endpoint")
    ...
    async def delete(self, item_id: int) -> None:
        ...
        """
        await self._delete("album", item_id=item_id)
    ...
    async def lookup(self, term: str) -> JsonArray:
        ...
        """
        response = await self.handler.request("album/lookup", params={"term": term})
